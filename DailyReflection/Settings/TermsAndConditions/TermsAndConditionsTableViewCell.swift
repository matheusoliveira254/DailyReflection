...
class TermsAndConditionsTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var bookIconImage: UIImageView!
...
/*
 ...
 You acknowledge that you have read this Agreement and agree to all its terms and conditions. By accessing and using the Mobile Application and Services you agree to be bound by this Agreement. If you do not agree to abide by the terms of this Agreement, you are not authorized to access or use the Mobile Application and Services. This terms and conditions p help of WebsitePolicies.comolicy was created with the
